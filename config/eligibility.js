...
export const MANUAL_QUOTE_RULES = [
  {
    id: 'device',
    label: '휴대폰·컴퓨터',
    reason: '리튬배터리 내장 기기는 항공사별 취급 조건이 달라 물류사 견적이 필요합니다.',
    notice: '한국 자급제 기기는 베트남에서 A/S 를 받을 수 없습니다. 주문 전 확인해 주세요.',
    keywords: [
      '스마트폰', '휴대폰', '핸드폰', '자급제', '갤럭시s', '갤럭시z', '갤럭시a', '아이폰', '픽셀폰',
      '노트북', '랩탑', '맥북', '그램', '갤럭시북', '아이맥', '데스크탑', '본체',
      '태블릿', '아이패드', '갤럭시탭', '모니터', '그래픽카드', '메인보드', '게임기', '플레이스테이션', '닌텐도',
    ],
  },
  {
    id: 'appliance',
    label: '가전·전열 기기',
    reason: '전자제품은 물류사 사전협의 대상입니다 (기기당 추가 요금이 있습니다).',
    notice: '접수 후 정확한 배송 요금을 안내드립니다.',
    // 다이슨 에어랩(59만원)처럼 고액 임계값(100만원) 아래로 새는 기기를 잡습니다.
    keywords: [
      '에어랩', '스타일러', '드라이기', '고데기', '헤어드라이어', '공기청정기', '가습기',
      '전기포트', '전동칫솔', '전기면도기', '전동면도기', '청소기', '스팀다리미', '다리미',
      '전기요', '전기장판', '에어프라이어', '커피머신', '블루투스스피커',
    ],
  },
  {
    id: 'high-value',
