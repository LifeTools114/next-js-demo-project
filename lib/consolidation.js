 ...
 *   2) 최소 청구무게(1kg)를 1회만 적용
 *   3) 1kg 올림 손실이 건별이 아니라 1회만 발생  ← 대개 여기서 가장 많이 아낌
 *
 * 예) 0.6kg 짜리 3건
 *     개별: 각 (0.6 + 0.25) = 0.85kg → 1kg 청구 × 3 = 3kg
 *     합배송: (1.8 + 0.25) = 2.05kg → 3kg 청구       = 3kg
 *   1kg 단위는 올림 손실이 커서 합배송 효과가 0.5kg 단위보다 큽니다.
 */
