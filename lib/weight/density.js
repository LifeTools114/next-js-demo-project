...
export const FORMS = [
   ...
   */
  { id: 'small-goods', label: '소형 잡화', keywords: ['수선패드', '깔창', '인솔', '발패드', '뒷꿈치', '뒤꿈치패드', '패치', '스티커', '밴드형', '키링', '노즈패드'], container: 'soft-pack', density: 1.0, defaultG: 30 },
  ...
  { id: 'toner-pad', label: '토너패드', keywords: ['토너패드', '필링패드', '패드'], exclude: ['수선', '운동화', '신발', '마우스', '매트', '방석', '의자', '침대', '충전', '전기', '냉각'], container: 'plastic-jar', density: 1.0, defaultMl: 150 },
  ...
  { id: 'laptop', label: '노트북', keywords: ['노트북', '랩탑', '맥북', '그램', '갤럭시북', '아이맥', '데스크탑'], container: 'laptop-box', density: 1.0, defaultG: 1500 },
  { id: 'tablet', label: '태블릿', keywords: ['태블릿', '아이패드', '갤럭시탭'], container: 'tablet-box', density: 1.0, defaultG: 500 },
  { id: 'phone', label: '스마트폰', keywords: ['스마트폰', '휴대폰', '핸드폰', '자급제', '아이폰', '갤럭시s', '갤럭시z', '갤럭시a', '픽셀폰'], container: 'phone-box', density: 1.0, defaultG: 200 },
  { id: 'wearable', label: '워치·웨어러블', keywords: ['스마트워치', '갤럭시워치', '애플워치', '스마트밴드'], container: 'small-device', density: 1.0, defaultG: 50 },
  { id: 'monitor', label: '모니터', keywords: ['모니터', '디스플레이'], container: 'bulky-pack', density: 1.0, defaultG: 4000 },

  { id: 'small-electronics', label: '소형 전자', keywords: ['이어폰', '헤드폰', '에어팟', '버즈', '충전기', '케이블', '마우스', '키보드', '거치대', '보조배터리'], container: 'small-device', density: 1.0, defaultG: 150 },
