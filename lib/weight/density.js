...
export const FORMS = [
   ...
   */
  { id: 'small-goods', label: '소형 잡화', keywords: ['수선패드', '깔창', '인솔', '발패드', '뒷꿈치', '뒤꿈치패드', '패치', '스티커', '밴드형', '키링', '노즈패드', '면도날', '수세미', '고무장갑'], container: 'soft-pack', density: 1.0, defaultG: 30 },
  ...
  { id: 'stick-food', label: '스틱·믹스', keywords: ['커피믹스', '믹스커피', '스틱커피', '티백'], container: 'food-pouch', density: 1.0, defaultG: 12 },
  ...
  { id: 'paper', label: '지류', keywords: ['화장지', '휴지', '키친타월', '기저귀', '생리대'], container: 'bulky-pack', density: 0.12, defaultG: 400 },
