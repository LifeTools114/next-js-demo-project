...
export const FORMS = [
  ...
  { id: 'apparel', label: '의류', keywords: ['티셔츠', '맨투맨', '후드', '니트', '자켓', '재킷', '패딩', '코트', '점퍼', '조끼', '바지', '팬츠', '조거', '슬랙스', '청바지', '원피스', '치마', '스커트', '양말', '속옷', '드로즈', '셔츠', '트레이닝'], container: 'soft-pack', density: 0.3, defaultG: 250 },
]
